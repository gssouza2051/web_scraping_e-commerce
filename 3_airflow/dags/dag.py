...
my_cosmos_dag = DbtDag(
    ...
    project_config=ProjectConfig(
        ...
        # (ex: você copiou para /usr/local/airflow/dbt/dw_e_commerce)
        dbt_project_path="/usr/local/airflow/dbt/dw_e_commerce",
        # Nome do projeto dbt (mesmo do dbt_project.yml)
        project_name="dw_e_commerce",
    ),
    ...
    dag_id=f"dag_dw_e_commerce_{dbt_env}",
